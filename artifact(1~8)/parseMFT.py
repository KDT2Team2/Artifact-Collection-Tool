...
def extract_mft(image_path, output_file):
    # Open the image file using pytsk3
...
if __name__ == "__main__":
    image_path = "\\\\.\\C:"  # Replace with the path to your disk image file
    output_file = "$MFT_COPY"  # Replace with the desired output file name
